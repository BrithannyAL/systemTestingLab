"use strict";
/* build-hook-start *//*00001*/try { require('c:\\Users\\brije\\.vscode\\extensions\\wallabyjs.console-ninja-1.0.364\\out\\buildHook\\index.js').default({tool: 'cypress', checkSum: '206a9fd5cf6af2a4fb0102B1IXV1EbUlxTUFUFVVJfVlQFVgME', mode: 'build'}); } catch(cjsError) { try { import('file:///c:/Users/brije/.vscode/extensions/wallabyjs.console-ninja-1.0.364/out/buildHook/index.js').then(m => m.default.default({tool: 'cypress', checkSum: '206a9fd5cf6af2a4fb0102B1IXV1EbUlxTUFUFVVJfVlQFVgME', mode: 'build'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
